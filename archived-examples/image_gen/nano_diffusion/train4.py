"""
https://github.com/VSehwag/minimal-diffusion/blob/main/main.py

python -m examples.image_gen.nano_diffusion.train4 --dataset cifar10 --arch UNetSmall --save-dir ./data/image_gen/nano_diffusion/train4/
"""
...
def main():
    ...
    # misc
    parser.add_argument("--save-dir", type=str, default="./data/image_gen/nano_diffusion/train4/")
