"""Adapted from https://github.com/faustomorales/vit-keras """
...
def build_model(
    ...
    x = tf.keras.layers.Input(
        shape=(image_size_tuple[0], image_size_tuple[1], num_channels)
    )
...
def vit_custom_b(
    ...
    """Build ViT-custom-b. All arguments passed to build_model."""
    model = build_model(
        **CONFIG_B,
        name="vit-custom-b",
...
def vit_custom_l(
    ...
    """Build ViT-custom-l. All arguments passed to build_model."""
    model = build_model(
        **CONFIG_L,
        patch_size=patch_size,
        name="vit-custom-l",
