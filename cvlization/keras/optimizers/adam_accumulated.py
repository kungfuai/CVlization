"""
https://github.com/CyberZHG/keras-gradient-accumulation/blob/master/keras_gradient_accumulation/optimizer_v2.py
"""
...
class AdamAccumulated(OptimizerV2):
    ...
    def _resource_apply_dense(self, grad, var):
        ...
        if not self.amsgrad:
            ...
            var_update = state_ops.assign_sub(
                var, lr * m_t / (v_hat_sqrt + epsilon_t), use_locking=self._use_locking
            )
    ...
    def get_config(self):
        ...
        config.update(
            {
                "accumulation_steps": self._serialize_hyperparameter(
                    "accumulation_steps"
                ),
