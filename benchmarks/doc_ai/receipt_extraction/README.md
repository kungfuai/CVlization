...
Simple benchmark tool to compare different document AI models on receipt/invoice OCR extraction.

## Directory Structure

```
benchmarks/doc_ai/receipt_extraction/
...
├── adapters/               # Model-specific adapter scripts
