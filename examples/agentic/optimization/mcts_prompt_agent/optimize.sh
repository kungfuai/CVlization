...
docker run --rm ${CVL_RUN_GPU:+--gpus="${CVL_RUN_GPU}"} \
  ...
  ${PROMPT_MCTS_LLM_PROVIDER:+--env PROMPT_MCTS_LLM_PROVIDER=${PROMPT_MCTS_LLM_PROVIDER}} \
  ${PROMPT_MCTS_LLM_MODEL:+--env PROMPT_MCTS_LLM_MODEL=${PROMPT_MCTS_LLM_MODEL}} \
  ${PROMPT_MCTS_LLM_TEMPERATURE:+--env PROMPT_MCTS_LLM_TEMPERATURE=${PROMPT_MCTS_LLM_TEMPERATURE}} \
