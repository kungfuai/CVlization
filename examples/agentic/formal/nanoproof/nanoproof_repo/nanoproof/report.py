...
def generate_header():
    ...
    header = f"""# nanoproof training report
    ...
    def generate(self):
        ...
        with open(report_file, "w", encoding="utf-8") as out_file:
            ...
            if os.path.exists(header_file):
                ...
                print(f"Warning: {header_file} does not exist. Did you forget to run `nanoproof reset`?")
...
# -----------------------------------------------------------------------------
# nanoproof-specific convenience functions
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Generate or reset nanoproof training reports.")
