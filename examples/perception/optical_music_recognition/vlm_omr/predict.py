...
PROMPTS = [
    ...
    },
    {
        ...
        "text": (
            ...
            "- !!LO: lines and *> lines are STANDALONE lines with NO tabs — they are NOT columns.\n"
            ...
            "!!LO:TX,t=Section A.,a  <- section label as plain text, read name from image\n"
            "!!LO:TX,t=Moderato.,a   <- tempo marking read from image\n"
            "!!LO:DY,t=mf,a\n"
            "=1 TAB =1\n"
            "2G 4D TAB 4d 4f# 4a\n"
            "4G 4D TAB 2g\n"
            ...
            "!!LO:TX,t=Section B.,a  <- new section label read from image\n"
            "!!LO:DY,t=f,a\n"
            "=9 TAB =9\n"
            "4A 4E TAB 4a 4cc\n"
            "...\n"
            ...
            "Read the title, composer, copyright, section names, key, tempo, and dynamics directly from the image. "
        ...
        "expectation": (
            ...
            "Output is directly renderable via verovio."
        ),
    },
]
