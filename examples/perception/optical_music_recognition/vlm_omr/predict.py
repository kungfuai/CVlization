...
PROMPTS = [
    ...
    },
    {
        ...
        "text": (
            ...
            "Use standard kern tokens: note durations (1, 2, 4, 8, 16), pitch (C, D, E, "
            "F, G, A, B with octave suffix), rests (r), barlines (=), clef (*clefG2, "
            "*clefF4), key (*k[b-]), time (*M4/4), voice beaming (L=beam start, "
            "J=beam end). Example first line: **ekern_1.0\t**ekern_1.0\n"
            "Transcribe as many measures as you can read."
        ),
        "expectation": (
            "Expected to fail / hallucinate — full symbolic transcription requires "
            "fine-tuning. Included as a lower-bound probe."
        ),
    },
]
