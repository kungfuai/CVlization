...
Image matching and sparse 3D reconstruction from uncalibrated images.
Uses dense correspondence matching with metric alignment for accurate scene geometry.
...
# DUSt3R imports (MASt3R builds on DUSt3R infrastructure)
...
def main():
    parser = argparse.ArgumentParser(
        description="Run MASt3R image matching and 3D reconstruction"
    )
    parser.add_argument(
        "--input",
        type=str,
