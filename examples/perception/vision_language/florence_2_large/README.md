...
Florence-2-Large is a vision language model from Microsoft Research with 0.77B parameters, providing a unified prompt-based interface for multiple vision tasks including captioning, OCR, object detection, and segmentation.
...
- **VRAM Usage**: ~2GB with float16
- **Model Download Size**: ~1.5GB
- **Tasks Verified**: Caption and OCR tasks tested successfully
