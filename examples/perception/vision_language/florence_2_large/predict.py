#!/usr/bin/env python3
"""
Florence-2-Large Vision Language Model - Microsoft's Unified Vision Foundation Model

This script demonstrates multimodal understanding using Florence-2-Large from Microsoft,
a compact 0.77B parameter model supporting captioning, OCR, object detection, and more.
...
def load_model(model_id: str = MODEL_ID, device: str = None):
    """
    Load the Florence-2-Large model and processor.
...
def run_inference(model, processor, image, task_prompt: str, text_input: str = None):
    """
    Run inference on an image using Florence-2-Large.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Florence-2-Large Vision Language Model",
...
Examples:
  ...
  python predict.py --image doc.jpg --task ocr --output result.json --format json
    ...
    print("=" * 60)
    print(f"Florence-2-Large - Microsoft Research")
