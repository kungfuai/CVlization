...
if __name__ == "__main__":
    """
    Sample usage:
    CUDA_VISIBLE_DEVICES=0 python -m cvlization.torch.training_pipeline.image_gen.vqgan.training_vqgan
    """
    ...
    parser.add_argument(
        ...
        type=str,
        default="mnist",
        help="Name of a Huggingface dataset (default: mnist)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="Number of workers for the dataloader (default: 2)",
    )
    parser.add_argument(
        "--epochs",
        type=int,
