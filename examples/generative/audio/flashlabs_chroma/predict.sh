...
IMG="${CVL_IMAGE:-flashlabs-chroma}"
...
docker "${DOCKER_ARGS[@]}" \
  ...
  --env "CHROMA_MODEL_ID=${CHROMA_MODEL_ID:-}" \
  --env "CHROMA_QUANT=${CHROMA_QUANT:-}" \
  --env "CHROMA_PROMPT_AUDIO=${CHROMA_PROMPT_AUDIO:-}" \
  --env "CHROMA_PROMPT_TEXT=${CHROMA_PROMPT_TEXT:-}" \
  --env "CHROMA_SYSTEM=${CHROMA_SYSTEM:-}" \
  --env "CHROMA_MAX_NEW_TOKENS=${CHROMA_MAX_NEW_TOKENS:-}" \
  --env "CHROMA_TEMPERATURE=${CHROMA_TEMPERATURE:-}" \
