...
| E4 | Switch attention to causal mask (Self-Forcing's `CausalWanModel`, needs torch≥2.5 env); forward without training | What does "free" causality look like — quality drop before any KD |
