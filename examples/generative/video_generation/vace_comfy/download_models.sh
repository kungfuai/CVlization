...
if [ ! -f $model_dir/Wan2.1-VACE-14B-Q6_K.gguf ]; then
# Wan2.1/Wan2.1-VACE-14B-Q6_K.gguf
    wget -P $model_dir https://huggingface.co/QuantStack/Wan2.1-VACE-14B-GGUF/resolve/main/Wan2.1-VACE-14B-Q6_K.gguf
fi
