...
# Image name
IMG="${CVL_IMAGE:-longcat_video}"

# Model and cache paths
MODELS_DIR="${LONGCAT_VIDEO_MODELS_DIR:-${HOME}/.cache/cvlization/models/longcat_video}"
...
# LongCat-Video requires torchrun for distributed execution
