...
if args.checkpoint_path:
    # Support passing either a file path or a directory
    if os.path.isdir(args.checkpoint_path):
        checkpoint_dir = args.checkpoint_path
        checkpoint_file = os.path.join(checkpoint_dir, "rewardforcing.pt")
    else:
    ...
    # Infer checkpoint step from directory name if possible
    checkpoint_step = os.path.basename(checkpoint_dir) or "checkpoint"
    if "_" in checkpoint_step:
        checkpoint_step = checkpoint_step.split("_")[-1]

    # Ensure downstream components use the directory for loading WAN assets
