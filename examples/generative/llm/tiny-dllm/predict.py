...
def main():
    ...
    data_text = None  # loaded lazily, cached to avoid double read
    if os.path.exists(tokenizer_path):
        ...
        with open(args.data, "r", encoding="utf-8") as f:
            data_text = f.read()
        tokenizer = CharTokenizer(data_text, add_mask_token=is_diffusion)
    ...
    if args.prompt:
        ...
        if data_text is None:
            ...
            with open(args.data, "r", encoding="utf-8") as f:
                data_text = f.read()
        seed_text = data_text[:args.prompt_len]
