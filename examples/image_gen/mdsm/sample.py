...
from .models import Res12_Quadratic, Res18_Quadratic, SE_Res18_Quadratic
...
from .analysis import save_sample_pdf
...
def main():
    ...
    if args.dataset == "cifar":
        ...
        # TODO: where is SE_Res18_Quadratic? Not found in the source repo. https://github.com/zengyi-li/MDSM
    ...
    if args.annealing_schedule == "exp":
        Nsampling = (
            2000  # exponential schedule with flat region in the beginning and end
        )
        Tmax, Tmin = 100, 1
        T = Tmax * np.exp(
