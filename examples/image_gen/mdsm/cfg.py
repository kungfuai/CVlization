...
def parse_args():
    ...
    parser.add_argument(
        "--n_iter", type=int, default=300000, help="number of iterations of training"
    )
    ...
    parser.add_argument(
        "--min_noise", type=float, default=0.05, help="minimum noise level"
    )

    parser.add_argument(
        "--max_noise", type=float, default=1.2, help="maximum noise level"
    )
    ...
    parser.add_argument("--log", type=str, default="Exp", help="logging folder name")
    ...
    parser.add_argument(
        "--rand_seed", type=float, default=42, help="costom random seed"
    )

    parser.add_argument("--cont", action="store_true", help="if continuing training")
    ...
    parser.add_argument(
        "--file_name", type=str, default="netE_MDSM", help="filename, for sampling"
    )
    ...
    parser.add_argument(
        "--sample_step_size", type=float, default=0.02, help="step size during sampling"
    )
