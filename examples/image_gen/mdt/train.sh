...
docker run --shm-size 16G --runtime nvidia -it \
	...
	mdt \
    python -m scripts.image_train --data_dir data/flying_mnist_images/train --batch_size 1 --image_size 256 --mask_ratio 0.30 --decode_layer 4 --model MDTv2_S_2 --diffusion_steps 1000
