...
MODEL_MENU = {
    ...
    "detr": {
        ...
        "checkpoint_url": "https://download.openm,mlab.com/mmdetection/v2.0/detr/detr_r50_8x2_150e_coco/detr_r50_8x2_150e_coco_20201130_194835-2c4b8974.pth",
    },
    "dyhead": {
...
if __name__ == "__main__":
    ...
    if hasattr(cfg.data.val, "dataset"):
        ...
        cfg.data.val.dataset.data_root = dsb.image_dir
