# adapted from https://github.com/lucidrains/video-diffusion-pytorch/blob/main/video_diffusion_pytorch/video_diffusion_pytorch.py
...
from video_diffusion_text import tokenize, bert_embed, BERT_MODEL_DIM
