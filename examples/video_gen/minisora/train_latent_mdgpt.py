...
def main():
    ...
    parser.add_argument("--tokens_input_file", type=str, default="data/latents/flying_mnist__model-kbu39ped_tokens_32frames_train.npy")
    parser.add_argument("--use_1d_pos_emb", action="store_true")
    parser.add_argument("--causal", action="store_true")
    parser.add_argument("--only_predict_last", action="store_true")
    ...
    # db = FlatTokenIds(token_ids=token_ids.reshape((token_ids.shape[0], -1)), vocab_size=vocab_size, start_token_id=VIDEO_BEGIN_TOKEN)
    ...
    train_pipe = MDGPTTrainingPipeline(
        config=MDGPTTrainingPipeline.Config(
            ...
            use_1d_pos_embedding=args.use_1d_pos_emb,
            causal=args.causal,
            only_predict_last=args.only_predict_last,
